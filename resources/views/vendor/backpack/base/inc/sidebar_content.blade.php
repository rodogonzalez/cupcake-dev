...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('store') }}'><i class='nav-icon fa fa-question'></i> Stores</a></li>

<li class='nav-item'><a class='nav-link' href='{{ backpack_url('cupcakerequest') }}'><i class='nav-icon fa fa-question'></i> Cup Cakes Requests</a></li>
